...
export const CONVERSATIONS_DATA: Conversation[] = [
    {
        id: 'conv-1',
        participants: [
            { id: 1, name: 'Gérard Dubois', avatarInitials: 'GD' },
        ...
        messages: [
            ...
            { id: 'msg-1-2', text: 'Bonjour Gérard, oui tout à fait. Je suis prêt à commencer dès lundi.', timestamp: '10:32', senderId: 2 },
