    ...
    const renderPage = () => {
        ...
        if (user.role === 'company') {
            const companyPages: { [key in Page]?: React.ReactNode } = {
                'dashboard': <CompanyDashboard user={user} onRateWorker={handleRateWorker} />,
            ...
            return companyPages[currentPage] || <CompanyDashboard user={user} onRateWorker={handleRateWorker} />;
        } else { // Worker role
