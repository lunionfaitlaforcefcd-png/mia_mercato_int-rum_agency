...
const CompanyDashboard: React.FC<CompanyDashboardProps> = ({ user, onRateWorker }) => {
    ...
    return (
        <>
            <div className="mb-8">
                <h2 className="text-3xl font-bold text-foreground">Bonjour {user.name},</h2>
                <p className="text-muted-foreground mt-1">Voici un aperçu de l'activité de {user.companyName}.</p>
            </div>
